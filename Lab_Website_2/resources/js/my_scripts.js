...
*/
	...
	var table = document.getElementById("stats_table");//Retrieve our table element
                ...
                {//Outer for loop iterates over each row
                        ...
                        {
                                if(counter == 0){
                                        cell_value1 = table.rows[row_counter].cells[col_counter].innerHTML;//Read in a cells current value
                                }else if(counter == 1){
                                        cell_value2 = table.rows[row_counter].cells[col_counter].innerHTML;//Read in a cells current value
                                }else{
                                        if(cell_value1 > cell_value2){
                                                table.rows[row_counter].cells[col_counter].innerHTML = cell_value1;//Update the actual html of the cell
                                                wins++;
                                        }else{
                                                table.rows[row_counter].cells[col_counter].innerHTML = cell_value2;//Update the actual html of the cell
                                                losses++;
                                        }
                                }
